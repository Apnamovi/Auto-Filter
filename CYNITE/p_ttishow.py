...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('Rᴇǫᴜᴇsᴛ Mᴏᴠɪᴇ Hᴇʀᴇ', url=f"https://t.me/+EIf3qY2zn8JmOGM9")
                  ]]
        reply_markup=InlineKeyboardMarkup(buttons)
        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                buttons = [[
                InlineKeyboardButton("ɢʀᴏᴜᴘ📌", url="ht")
            ]]
                ...
                photo="https://telegra.ph/file/a27d630e4f79a81898121.jpg",
